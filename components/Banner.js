...
const styles = {
  ...
  welcomeContainer:"sm:flex justify-center items-center w-screen",
  welcome: "text-[4rem] font-medium sm:text-5xl text-xl",
  typeWriter: "sm:text-[2.5rem] text-[1.7rem] sm:mt-10 h-[2rem]",
  secondContainer: "flex flex-row mt-[5rem]",
  whyLeft: "sm:w-1/2",
  whyRight: "max-w-2xl h-[7rem] hidden sm:flex items-center justify-center",
